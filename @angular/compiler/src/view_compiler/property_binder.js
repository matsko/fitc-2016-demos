    ...
    boundProps.forEach(function (boundProp) {
        ...
        switch (boundProp.type) {
            ...
            case PropertyBindingType.Animation:
                ...
                var queryVariable = o.variable('elementQueries');
                var queryStmt = queryVariable.set(o.literalArr(queryExprs_1)).toDeclStmt();
                updateStmts.push(queryStmt);
                view.detachMethod.addStmt(queryStmt);
                updateStmts.push(animationFnExpr.callFn([o.THIS_EXPR, renderNode, queryVariable, oldRenderVar, newRenderVar]).toStmt());
                view.detachMethod.addStmt(animationFnExpr.callFn([o.THIS_EXPR, renderNode, queryVariable, oldRenderValue, emptyStateValue])
                    .toStmt());
                break;
        }
